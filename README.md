...
[![My Skills](https://skillicons.dev/icons?i=apple,arch,azure,bash,bitbucket,cloudflare,debian,discord,docker,fediverse,git,github,githubactions,gitlab,gmail,ai,kali,kubernetes,linkedin,linux,md,mastodon,mint,nginx,powershell,py,raspberrypi,redhat,regex,ubuntu,vim,visualstudio,vscode,windows,wordpress&theme=light)](https://skillicons.dev)
